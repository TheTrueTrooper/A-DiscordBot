...
namespace DiscordBot2._0
{
    ...
    public class Anime
    {
        ...
        /// </summary>
        public static Func<Anime, string> ToStringOverRide;
    ...
    public class AnimeResult
    {
        ...
        /// an exposed point to override the to string method with a function or lambda
        /// </summary>
        public static Func<AnimeResult, string> ToStringOverRide;
    ...
    public class Manga
    {
        ...
        /// an exposed point to override the to string method with a function or lambda
        /// </summary>
        public static Func<Manga, string> ToStringOverRide;
    ...
    public class MangaResult
    {
        ...
        /// an exposed point to override the to string method with a function or lambda
        /// </summary>
        public static Func<MangaResult, string> ToStringOverRide;
