...
namespace DiscordBot2._0
{
    ...
    public class Memer
    {
        static Font _Font = new Font(new FontFamily(GenericFontFamilies.Serif), 15);
        ...
        public Image DrawText(string Text, string Text2, string Path)
        {
            ...
            _Graphics.DrawString(Text, _Font, Brushes.Black, new Rectangle(0, 0, (int)I.Width, (int)(I.Height / 4)), SF);
            _Graphics.DrawString(Text, _Font, Brushes.DarkSlateBlue, new Rectangle(0, 0, (int)I.Width, (int)(I.Height / 4)), SF);

            _Graphics.DrawString(Text2, _Font, Brushes.Black, new Rectangle(0, (int)(I.Height * 3 / 4), (int)I.Width, (int)(I.Height / 4)), SF);
            _Graphics.DrawString(Text2, _Font, Brushes.Black, new Rectangle(0, (int)(I.Height * 3 / 4), (int)I.Width, (int)(I.Height / 4)), SF);
            _Graphics.DrawString(Text2, _Font, Brushes.DarkSlateBlue, new Rectangle(0, (int)(I.Height * 3 / 4), (int)I.Width, (int)(I.Height / 4)), SF);
